...
logging.basicConfig(filename="log_cardiac_global.txt",
                            filemode='a',
...
def build_discriminator():
    ...
    netD = Discriminator(n_channels=4).to(args.device)
...
def load_model(checkpoint_file):
    ...
    modelG.load_state_dict(checkpoint['model'])
    ...
    modelD.load_state_dict(checkpoint['disc'])
