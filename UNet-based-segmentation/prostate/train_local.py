...
if __name__ == "__main__":
    ...
    model_type = 'UNet'
    save_path = '/media/htic/NewVolume5/midl_experiments/nll/{}_{}/models_local'.format(object_type,model_type)
    ...
    size = 25 #Prostate ROI of Size 50x50.

    writer = SummaryWriter(log_dir='/media/htic/NewVolume5/midl_experiments/nll/{}_{}/models_local/summary'.format(object_type,model_type))
    ...
    logging.info('Model: UNet + Loss: StaticContextLoss {}'.format(object_type)) 
        ...
        for i,(inputs,targets,coord) in enumerate(tqdm(trainLoader)):
            ...
            with torch.set_grad_enabled(True):
                ...
                for i,coord in enumerate(coord):
                    ...
                    local_outputs = outputs[i,:,cy-size:cy+size,cx-size:cx+size]
                    local_targets = targets[i,:,cy-size:cy+size,cx-size:cx+size]
